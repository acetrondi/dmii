    ...
    <footer className="bg-course-main text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Digital Marketing Institute of India - Empowering careers with AI-driven marketing skills.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Education Avenue, Bangalore, Karnataka 560001</span>
              </li>
              <li className="flex items-start">
                <span className="text-course-accent mr-2">📱</span>
        ...
        <div className="border-t border-gray-700 mt-12 pt-6 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Digital Marketing Institute of India. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
