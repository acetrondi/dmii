        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="w-full lg:w-1/2 space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-course-main scroll-reveal">
              {title.toUpperCase()} IN{" "}
              <span className="text-gradient">AI DIGITAL MARKETING</span>
            </h1>

            <p className="text-xl text-course-muted max-w-xl scroll-reveal">
              Learn digital marketing from scratch with the power of AI. Master
              the fundamentals and get hands-on experience with industry-leading
              tools.
            </p>
              ...
              <div className="rounded-2xl overflow-hidden glass-card p-6 shadow-xl animate-float">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-sm">
                      Live classes with marketing experts
                    </span>
                  </li>
                  <li className="flex items-start">
                    <div className="mt-1 mr-2 bg-course-accent/20 p-1 rounded-full">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex items-end">
                    <span className="text-3xl font-bold text-course-main">
                      ₹{price}
                    </span>
                    <span className="text-course-muted ml-2">
                      all-inclusive
                    </span>
                  </div>
                </div>
